...
public class ReadConverter {
	...
	private IStudentDao studentDao = new StudentDaoImpl(new Student[100]); 
	private ILecturerDao lecturerDao = new LecturerDaoImpl(new Lecturer[100]); 
	private ILectureDao lectureDao = new LectureDaoImpl(new Lecture[100]); 
	private ICourseDao courseDao = new CourseDaoImpl(new Course[100]); 
	...
	private Student readStudent(String string)
	{
		...
		Student student = new Student(Long.parseLong(str[0]),str[2],str[1],str[3]);
		return student;
	}
	...
	{
		String[] str = string.split("[;]");
		Lecturer lecturer = new Lecturer(Long.parseLong(str[0]),str[2],str[1],str[3]);
		return lecturer;
	}
	...
	{
		String[] str = string.split("[;]");
		Lecture lecture = new Lecture(Long.parseLong(str[0]),str[1],new Date(Integer.parseInt(str[2].split("[-]")[0]),Integer.parseInt(str[2].split("[-]")[1]),Integer.parseInt(str[2].split("[-]")[2])));
		return lecture;
	}
	...
	{
		String[] str = string.split("[;]");
		Course course = new Course(Integer.parseInt(str[4]),Integer.parseInt(str[3]),Long.parseLong(str[0]),str[1],new Date(Integer.parseInt(str[6].split("[-]")[0]),Integer.parseInt(str[6].split("[-]")[1]),Integer.parseInt(str[6].split("[-]")[2])),new Date(Integer.parseInt(str[7].split("[-]")[0]),Integer.parseInt(str[7].split("[-]")[1]),Integer.parseInt(str[7].split("[-]")[2])),str[2]);
